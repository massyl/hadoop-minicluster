  ...
  def matchHadoopDependencies(x: String): Seq[ModuleID] = x match {
    case "2.0.0-mr1-cdh4.2.0" =>
      Seq(
        ...
        "org.apache.hadoop" % "hadoop-common" % "2.0.0-cdh4.3.0" intransitive(),
        ...
        "org.apache.hadoop" % "hadoop-hdfs" % "2.0.0-cdh4.3.0" intransitive(),
        ...
        "org.apache.mrunit" % "mrunit" % "1.0.0" % "test" classifier "hadoop2" intransitive(),

...
public class InMapperCombiner<KEY extends WritableComparable, VALUE extends Writable> {
            ...
            protected boolean removeEldestEntry(Map.Entry<KEY, VALUE> eldest) {
                ...
                if (isFull) {
                    try {
                        ...
                        System.out.print("The LRU is full, size is " + size() + " and max size is " + maxCacheCapacity + "\n");
        ...
        if (combiningFunction != null) {
            try {
                if (!lruCache.containsKey(key)) {
                    ...
                    // System.out.print("Run in-mapper combinner key:" + key.toString() + " v1: "  + lruCache.get(key).toString() +" v2: " + value.toString() + " lrusize: " +lruCache.size() +"\n"  );
    ...
    public void flush(Mapper.Context context) throws IOException, InterruptedException {
        ...
        System.out.print("CleanUp: " + lruCache.size() + "\n");
        lruCache.clear();
    }
